                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group-attached">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <form action="<?php echo base_url() ?>galeri/saveKonten" enctype="multipart/form-data" class="dropzone no-margin" id="frm-gambar">
                                                        <div class="fallback">
