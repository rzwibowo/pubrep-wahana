...
<body class="fixed-header dashboard menu-pin menu-behind">
                        ...
                        <tr>
                          ...
                          <td class="text-right">
                            <div class="btn-group btn-group-xs sm-m-t-10">
                              <button type="button" class="btn btn-default" onclick="edit(<?php echo $j->id_jabatan ?>)"><i class="fa fa-pencil"></i>
                              </button>
                              <button type="button" class="btn btn-default" onclick="hapus(<?php echo $j->id_jabatan ?>)"><i class="fa fa-trash"></i>
                              </button>
                            </div>
                          </td>
                        </tr>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header clearfix text-left">
                    ...
                    <h5>Data <span class="semi-bold">Jabatan</span></h5>
                  </div>
                  <form role="form" name="form-jabatan" method="POST" action="<?php echo base_url() ?>jabatan/save">
  ...
  <script>
    ...
    function edit(id) {
      axios.get('<?php echo base_url() ?>jabatan/get/' + id)
        .then(res => {
    ...
    function hapus(id) {
      Swal.fire({
        ...
        if (result.value) {
          location.assign('<?php echo base_url() ?>jabatan/delete/' + id)
        }
      })
    }
  </script>
