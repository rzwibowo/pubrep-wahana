...
<body class="fixed-header dashboard menu-pin menu-behind">
                    ...
                    <div class="row">
                        ...
                        <div class="card card-default">
                            <div class="card-header ">
                                <div class="card-title">Laporan Transaksi Parkir
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 offset-md-3 text-right">
                                        ...
                                        <a href="<?php echo base_url() ?>parkir/cetak_lap" class="btn btn-primary btn-cons disabled" id="link-cetak" target="_blank">
    ...
    <script>
        ...
        function getData(start, end) {
            axios.get(`<?php echo base_url() ?>parkir/dataLap/${start.format('YYYY-MM-DD')}/${end.format('YYYY-MM-DD')}`)
                .then(res => {
                    tabel_utama.destroy()
                    ...
                    if (res.data.length > 0) {
                        $('#link-unduh').attr('href', `${base_url}parkir/cetak_lap/laporan/excel/${start.format('YYYY-MM-DD')}/${end.format('YYYY-MM-DD')}`)
                        $('#link-unduh').removeClass('disabled')

                        $('#link-cetak').attr('href', `${base_url}parkir/cetak_lap/laporan/dokumen/${start.format('YYYY-MM-DD')}/${end.format('YYYY-MM-DD')}`)
